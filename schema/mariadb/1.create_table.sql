...
(
    YEARID  INTEGER default NULL null,
    player수 INTEGER default NULL null,
    평균경기수   DOUBLE    default NULL null,
    평균타석    DOUBLE    default NULL null,
    평균타율    DOUBLE    default NULL null,
    평균출루율   DOUBLE    default NULL null,
    평균장타율   DOUBLE    default NULL null,
    최소경기수   DOUBLE    default NULL null,
    최소타석    DOUBLE    default NULL null,
    최소타율    DOUBLE    default NULL null,
    최소출루율   DOUBLE    default NULL null,
    최소장타율   DOUBLE    default NULL null,
    최대경기수   DOUBLE    default NULL null,
    최대타석    DOUBLE    default NULL null,
    최대타율    DOUBLE    default NULL null,
    최대출루율   DOUBLE    default NULL null,
    최대장타율   DOUBLE    default NULL null
);
create table ex_1
(
    컬럼A int null,
